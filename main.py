from src.data_extraction.galaxy_extractor import GalaxyExtractor, TOOL_LIMIT, WORKFLOW_LIMIT
...
def run_pipeline():
    ...
    try:
        extractor = GalaxyExtractor(url=settings.GALAXY_URL, api_key=settings.GALAXY_API_KEY)
